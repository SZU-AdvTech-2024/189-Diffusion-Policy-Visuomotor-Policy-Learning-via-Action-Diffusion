...
from diffusion_policy.env.qf_push_square.qf_push_square_env import QfPushSquareEnv
from diffusion_policy.env.qf_push_square.pymunk_keypoint_manager import PymunkKeypointManager
import numpy as np

class QfPushSquareKeypointsEnv(QfPushSquareEnv):
    def __init__(self,
            legacy=False,
            block_cog=None, 
            damping=None,
